...
class Router
{
	...
	function ignite($url)
	{
		...
		if ($module && is_file($this->modulesPath.$module.CONTROLLERS_DIR.DS.$controller.'.php')) {
			// todo
			// require_once($this->modulesPath.$module.CONTROLLERS_DIR.DS.$controller.'.php');
		}
		else {
			// require_once($this->controllersPath.$dir.$controller.'.php');
